...
ROOT_HOSTCONF = "arches_ciim_app.hosts"
DEFAULT_HOST = "arches_ciim_app"
...
DATATYPE_LOCATIONS.append("arches_ciim_app.datatypes")
FUNCTION_LOCATIONS.append("arches_ciim_app.functions")
ETL_MODULE_LOCATIONS.append("arches_ciim_app.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("arches_ciim_app.search_components")
...
SECRET_KEY = "#mw^*#2@e^d^6_oz53br%t7%k^)db8wo3dua4!1-i07f8w4)lt"
